...
export default function Shop_All() {
    ...
    const [selectedProductId, setSelectedProductId] = useState(null); // New state to track the selected product ID
    ...
    const handleOpenForm = (id) => {
        ...
        setSize(''); // Reset size when opening the form for a new product
        setOpenForm(true);
    };
                        ...
                        <div>
                            <div className="button">
                                <Button
                                    ...
                                    color="secondary"
                                    size="large"
                                    onClick={() => handleOpenForm(product.id)} // Pass the product id here
                                >
                                    Add to Cart
                                </Button>
                            </div>
